...
<div class="page-break-before">
  ...
  <table style="width: 100%;">
    <tr>
      <td style="width: min-content;">૧</td>
      <td colspan="2">
        <span style="display: block">
          સરકારી કર્મચારીનું નામ :
        </span>(સેવાપોથીમાં નોંધ્યા પ્રમાણે જો સુધારેલ હોય તો ગેઝેટનો આધાર
        રાખવો)
      </td>
      <td>
    ...
    <tr>
      ...
      <td colspan="5">
        <div class="no-spacing">
          <p>
            મારા યોગ્ય રીતે શાખ કરાવેલ / પ્રમાણિત કરાવેલા નીચેના દસ્તાવેજોની
            ત્રણ નકલ સામેલ છે.
          </p>
          <p class="indent">(૧) ગુજરાતી તેમજ અંગ્રેજીમાં સહીના ત્રણ નમૂના</p>
          <p class="indent">
