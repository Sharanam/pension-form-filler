...
<table class="border">
  <thead>
    <tr>
      ...
      <th>જે આકસ્મિક ધટના બનતા નિયુક્તિ પાત્ર અમાન્ય ઠરે તે આકસ્મિક ઘટના</th>
      <th
        >બચ્તદાર ની પહેલા નિયુક્તિનું મૃત્યુ થાય તેવા પ્રસંગે નિયુક્તિ નો હક જે
        વ્યક્તિ /વ્યક્તિઓને મળે તેમના નામ , સરનામાં અને સગપણ</th
      >
        ...
        <td class="initial">
          <div class="no-print">
            <textarea
              ...
              value={tmp[0]}
              on:change={(e) => {
                $data[index].niyuktiTable[i][0] = e.target.value;
              }}
            />
          </div>
        ...
        <td class="initial">
          <div class="no-print">
            <input
              ...
              value={tmp[1]}
              on:change={(e) => {
                $data[index].niyuktiTable[i][1] = e.target.value;
              }}
              placeholder="wife"
            />
          </div>
          ...
          <div class="no-print">
            <div>
              <input
                ...
                value={tmp[2][0]}
                on:change={(e) => {
                  $data[index].niyuktiTable[i][2] = e.target.value;
                }}
                placeholder="58"
              />
            </div>
            <div class="dob">
              <input
                ...
                value={tmp[2][1][0]}
                on:change={(e) => {
                  $data[index].niyuktiTable[i][2][1][0] = e.target.value;
                  updateAge(i);
                }}
                placeholder="dd"
              />
              <input
                ...
                value={tmp[2][1][1]}
                on:change={(e) => {
                  $data[index].niyuktiTable[i][2][1][1] = e.target.value;
                  updateAge(i);
                }}
                placeholder="mm"
              />
              <input
                ...
                value={tmp[2][1][2]}
                on:change={(e) => {
                  $data[index].niyuktiTable[i][2][1][2] = e.target.value;
                  updateAge(i);
                }}
                placeholder="yyyy"
              />
        ...
        <td class="initial">
          <div class="no-print">
            <input
              ...
              value={tmp[3]}
              on:change={(e) => {
                $data[index].niyuktiTable[i][3] = e.target.value;
              }}
              placeholder="100%"
            />
          </div>
        ...
        <td class="initial">
          <div class="no-print">
            <input
              ...
              value={tmp[4]}
              on:change={(e) => {
                $data[index].niyuktiTable[i][4] = e.target.value;
              }}
            />
          </div>
          <span class="no-screen">
        ...
        <td class="initial">
          <div class="no-print">
            <textarea
              ...
              value={tmp[5]}
              on:change={(e) => {
                $data[index].niyuktiTable[i][5] = e.target.value;
              }}
            />
          </div>
          <span class="no-screen">
            {#if tmp[5]}
              {#each tmp[5].split("\n") as line}
                <span style="display:block">{toGujarati(line)}</span>
              {/each}
            {/if}
          </span>
        </td>
        <td class="initial">
          <div class="no-print">
            <input
              ...
              value={tmp[6]}
              on:change={(e) => {
                $data[index].niyuktiTable[i][6] = e.target.value;
              }}
            />
          </div>
          <span class="no-screen">
            ...
            <button
              on:click={() => {
                if (confirm("Are you sure you want to delete this row?")) {
                  $data[index].niyuktiTable = $data[index].niyuktiTable.filter(
                    (_, j) => j !== i
                  );
                }
              }}
